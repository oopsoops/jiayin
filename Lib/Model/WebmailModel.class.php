...
class WebmailModel extends Model {
    ...
    protected $_validate = array(
		array('title', 'require', '信件主题必须填写！', 1),//1为必须验证
        array('content', 'require', '信件内容必须填写！', 1),//1为必须验证
		//array('productname', '', '此商品已经存在', 0, 'unique', self::MODEL_BOTH),
...
//		array('userpass','md5',self:: MODEL_BOTH,'function'),
  //  );
    /*
